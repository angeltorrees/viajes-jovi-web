        ...
        if (nacEl && data.nacionales && data.nacionales.length) {
            ...
            data.nacionales.forEach(function (item) {
                ...
                col.innerHTML =
                    ...
                    '      <a href="' + ('https://wa.me/5214777341974?text=' + encodeURIComponent('Hola! Me interesa el tour: ' + (item.titulo || ''))) + '" target="_blank" rel="noopener" class="btn-hover text-white"><i class="fab fa-whatsapp me-1"></i> Cotizar <i class="fa fa-arrow-right ms-2"></i></a>' +
                    '    </div>' +
                    '  </div>' +
                    ofertaHtml +
                    '  <div class="national-plus-icon">' +
                    '    <a href="' + ('https://wa.me/5214777341974?text=' + encodeURIComponent('Hola! Me interesa el tour: ' + (item.titulo || ''))) + '" target="_blank" rel="noopener" class="my-auto"><i class="fab fa-whatsapp fa-2x text-white"></i></a>' +
                    '  </div>' +
                    '</div>';
        ...
        if (intEl && data.internacionales && data.internacionales.length) {
            ...
            data.internacionales.forEach(function (item) {
                ...
                div.innerHTML =
                    ...
                    '    <a href="' + ('https://wa.me/5214777341974?text=' + encodeURIComponent('Hola! Me interesa el tour internacional: ' + (item.titulo || '') + ' (' + (item.ciudades || '') + ')')) + '" target="_blank" rel="noopener" class="btn-hover text-white"><i class="fab fa-whatsapp me-1"></i> Cotizar</a>' +
                    '  </div>' +
                    '</div>' +
    ...
    function renderPaquetesAsombrosos(items) {
        ...
        items.forEach(function (p) {
            ...
            div.addEventListener('click', function(e) {
                if (e.target.closest('a')) return;
                window.open('https://wa.me/5214777341974?text=' + encodeURIComponent('Hola! Me interesa el paquete: ' + (p.titulo || '') + ' - ' + (p.destino || '') + ' (' + (p.precio || '') + ')'), '_blank');
            });
            div.innerHTML =
                ...
                '      <a href="' + ('https://wa.me/5214777341974?text=' + encodeURIComponent('Hola! Me interesa el paquete: ' + (p.titulo || '') + ' - ' + (p.destino || '') + ' (' + (p.precio || '') + ')')) + '" target="_blank" rel="noopener" class="btn-hover btn text-white py-2 px-4"><i class="fab fa-whatsapp me-1"></i> Cotizar</a>' +
                '    </div>' +
                '  </div>' +
                '</div>';
